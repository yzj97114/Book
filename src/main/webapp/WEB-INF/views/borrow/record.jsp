                ...
                <form id="searchForm" class="layui-form">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" name="cardNo" placeholder="借阅证编号">
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">读者姓名：</label>
                        <div class="layui-input-inline">
                            <input class="layui-input" name="readerName" placeholder="读者姓名">
                        </div>
                    </div>
                    <div class="layui-inline">
...
<myJs>
    <script type="text/javascript" src="${ctx}/assets/js/borrow/record.js"></script>
</myJs>
</body>
</html>