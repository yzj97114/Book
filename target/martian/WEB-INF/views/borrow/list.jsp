        ...
        <div class="search">
            <blockquote class="layui-elem-quote">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input class="layui-input width250" name="bookName" placeholder="图书名称">
                    </div>
                </div>
                <button class="layui-btn" type="button" onclick="searchBook()" style="margin-left: 10px;"><i class="layui-icon">&#xe615;</i>查询
                </button>
            </blockquote>
        </div>
...
<myJs>
    <script type="text/javascript" src="${ctx}/assets/js/borrow/list.js"></script>
</myJs>
</body>
</html>